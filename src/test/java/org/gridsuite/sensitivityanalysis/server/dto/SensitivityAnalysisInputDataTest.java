    ...
    public void test() {
        SensitivityAnalysisInputData sensitivityAnalysisInputData1 = SensitivityAnalysisInputData.builder()
            .sensitivityInjectionsSets(List.of(SensitivityInjectionsSet.builder()
                .monitoredBranches(List.of(new ContainerIdent(UUID.randomUUID(), "u1"), new ContainerIdent(UUID.randomUUID(), "u2")))
                .injections(List.of(new ContainerIdent(UUID.randomUUID(), "u3"), new ContainerIdent(UUID.randomUUID(), "u4")))
                .distributionType(SensitivityAnalysisInputData.DistributionType.REGULAR)
                .contingencies(List.of(new ContainerIdent(UUID.randomUUID(), "u5"))).build()))
            .sensitivityInjections(List.of(SensitivityInjection.builder()
                .monitoredBranches(List.of(new ContainerIdent(UUID.randomUUID(), "u6"), new ContainerIdent(UUID.randomUUID(), "u7")))
                .injections(List.of(new ContainerIdent(UUID.randomUUID(), "u8"), new ContainerIdent(UUID.randomUUID(), "u9")))
                .contingencies(List.of(new ContainerIdent(UUID.randomUUID(), "u10"), new ContainerIdent(UUID.randomUUID(), "u11"))).build()))
            .sensitivityHVDCs(List.of(SensitivityHVDC.builder()
                .monitoredBranches(List.of(new ContainerIdent(UUID.randomUUID(), "u12")))
                .sensitivityType(SensitivityAnalysisInputData.SensitivityType.DELTA_MW)
                .hvdcs(List.of(new ContainerIdent(UUID.randomUUID(), "u13")))
                .contingencies(List.of(new ContainerIdent(UUID.randomUUID(), "u14"))).build()))
            .sensitivityPSTs(List.of(SensitivityPST.builder()
                .monitoredBranches(List.of(new ContainerIdent(UUID.randomUUID(), "u15")))
                .sensitivityType(SensitivityAnalysisInputData.SensitivityType.DELTA_A)
                .psts(List.of(new ContainerIdent(UUID.randomUUID(), "u16"), new ContainerIdent(UUID.randomUUID(), "u17")))
                .contingencies(List.of(new ContainerIdent(UUID.randomUUID(), "u18"))).build()))
            .sensitivityNodes(List.of(SensitivityNodes.builder()
                .monitoredVoltageLevels(List.of(new ContainerIdent(UUID.randomUUID(), "u19")))
                .equipmentsInVoltageRegulation(List.of(new ContainerIdent(UUID.randomUUID(), "u20")))
    ...
    public void testFilterPbInputTranslation() {
        ...
        SensitivityAnalysisInputData inputData = inputBuilder
            ...
            .sensitivityInjections(List.of(SensitivityInjection.builder()
                .monitoredBranches(List.of(new ContainerIdent(UUID.randomUUID(), "u6"), new ContainerIdent(UUID.randomUUID(), "u7")))
                .injections(List.of(new ContainerIdent(UUID.randomUUID(), "u8"), new ContainerIdent(UUID.randomUUID(), "u9")))
                .contingencies(List.of(new ContainerIdent(UUID.randomUUID(), "u10"), new ContainerIdent(UUID.randomUUID(), "u11")))
                .build()))
            .build();
        context = new SensitivityAnalysisRunContext(NETWORK_UUID, VARIANT_ID,
            Collections.emptyList(), inputData, null, null, null, null);
