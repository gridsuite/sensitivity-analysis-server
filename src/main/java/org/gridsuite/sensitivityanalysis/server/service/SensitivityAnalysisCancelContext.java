 ...
 */
public class SensitivityAnalysisCancelContext {

    private final UUID resultUuid;

    private final String receiver;

    public SensitivityAnalysisCancelContext(UUID resultUuid, String receiver) {
    ...
    public static SensitivityAnalysisCancelContext fromMessage(Message<String> message) {
        ...
        return new SensitivityAnalysisCancelContext(resultUuid, receiver);
    }
